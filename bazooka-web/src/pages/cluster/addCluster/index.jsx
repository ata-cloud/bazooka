      ...
      <Card>
        ...
        <div>
          <Row type="flex">
            ...
            <Col span={14}>
              <div className={stylesAddCluster.flexRightContent}>
                <div>
                  ...
                  <p><a href="https://docs.d2iq.com/mesosphere/dcos/1.11/" target="_black">了解更多</a></p>
                </div>
                <div>
    ...
    return (
      <Card className={styles.marginT}>
        ...
        <div>
          <Row type="flex">
            <Col span={10}>
              <img src={IMAGE.KUBERNETES_JG} className={stylesAddCluster.jgImg} />
            </Col>
            <Col span={12}>
              <div className={stylesAddCluster.flexRightContent}>
                <div>
                  ...
                  <p><a href="https://kubernetes.io/docs/home/" target="_black">了解更多</a></p>
                </div>
                <div>
