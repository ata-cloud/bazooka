 ...
 * @date 2019-07-16
 */
public interface EnvService extends IService<net.atayun.bazooka.pms.api.EnvDto, RmsEnvEntity> {
     ...
     * @return
     */
    List<net.atayun.bazooka.pms.api.EnvDto> list(EnvQueryReq envQueryReq);
