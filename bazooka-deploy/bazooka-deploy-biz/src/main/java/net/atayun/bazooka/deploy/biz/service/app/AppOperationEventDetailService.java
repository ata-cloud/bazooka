 ...
 * @date 2019-08-01
 */
public interface AppOperationEventDetailService {
     ...
     */
    void insertByParam(Long eventId, String eventRemark);
     ...
     */
    AppOperationEventDetailEntity selectByEventId(Long eventId);
