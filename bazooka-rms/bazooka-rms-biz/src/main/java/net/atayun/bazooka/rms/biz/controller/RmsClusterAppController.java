...
import net.atayun.bazooka.rms.api.api.RmsClusterAppApi;
 ...
 * @work 资源集群App controller
 */
@RestController
@RequestMapping("/clusterApp")
public class RmsClusterAppController implements RmsClusterAppApi {
