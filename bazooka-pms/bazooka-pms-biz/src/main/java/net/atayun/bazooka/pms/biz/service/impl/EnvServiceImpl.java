...
import net.atayun.bazooka.combase.mlb.MlbServiceDto;
import net.atayun.bazooka.pms.api.EnvDto;
import net.atayun.bazooka.pms.biz.dal.dao.RmsEnvLogMapper;
import net.atayun.bazooka.pms.biz.dal.dao.RmsEnvMapper;
...
import net.atayun.bazooka.pms.biz.enums.OptType;
...
import net.atayun.bazooka.pms.api.param.*;
...
import static net.atayun.bazooka.combase.utils.CommonUtil.defaultValue;
import static net.atayun.bazooka.combase.utils.OrikaCopyUtil.copyProperty;
import static net.atayun.bazooka.pms.api.enums.EnvState.NORMAL;
...
import static net.atayun.bazooka.pms.api.enums.RmsResultCode.*;
 ...
 */
@Service
public class EnvServiceImpl extends AbstractService<Long, net.atayun.bazooka.pms.api.EnvDto, RmsEnvEntity, RmsEnvMapper> implements EnvService {
    ...
    @Override
    public List<net.atayun.bazooka.pms.api.EnvDto> list(EnvQueryReq req) {
    ...
    private net.atayun.bazooka.pms.api.EnvDto convertToEnvDto(RmsEnvEntity record) {

        net.atayun.bazooka.pms.api.EnvDto env = copyProperty(record, net.atayun.bazooka.pms.api.EnvDto.class);
        if (isNull(env)) {
            return null;
        }
        // get cluster info
