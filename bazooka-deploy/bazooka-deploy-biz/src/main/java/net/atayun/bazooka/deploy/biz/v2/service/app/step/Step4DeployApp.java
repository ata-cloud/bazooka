 ...
 */
@Component
@StrategyNum(superClass = Step.class, number = FlowStepConstants.DEPLOY)
public class Step4DeployApp extends Step4Platform implements SinglePhase {

    @Override
    protected void customWork(Platform platform, AppOpt appOpt, AppOptFlowStep appOptFlowStep, StepLogBuilder stepLogBuilder) {
        platform.deploy(appOpt, appOptFlowStep, stepLogBuilder);
    }
}