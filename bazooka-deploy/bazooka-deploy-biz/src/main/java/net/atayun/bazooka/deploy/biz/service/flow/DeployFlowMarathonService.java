 ...
 * @date 2019-07-23
 */
public interface DeployFlowMarathonService {
     ...
     */
    void insertEntity(DeployFlowMarathonEntity deployFlowMarathonEntity);

    DeployFlowMarathonEntity selectByDeployFlowId(Long deployFlowId);
}
