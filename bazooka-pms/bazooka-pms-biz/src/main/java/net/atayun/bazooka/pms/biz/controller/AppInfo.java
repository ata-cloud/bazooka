...
import net.atayun.bazooka.pms.api.param.EnvMlbPortUsedReq;
import net.atayun.bazooka.pms.api.param.EnvMlbPortUsedRsp;
...
public class AppController implements AppApi {
    ...
    public Result<AppInfoDto> addAppInfo(@PathVariable Long projectId, @RequestBody @Validated AppInfoAddFormParam formParam) {
        AppInfo appInfo = AppInfoConverter.appInfo(projectId, formParam);
        appInfo = appService.addAppInfo(appInfo);
        return Result.ok(appInfoService.convertEntityToDto(appInfo));
    }
    ...
    public Result<AppInfoDto> updateAppInfo(@PathVariable Long appId, @RequestBody @Validated AppInfoUpdateFormParam formParam) {
        AppInfoEntity appInfoEntity = AppInfoConverter.appInfo(appId, formParam);
