 ...
 * @date 2019-07-26
 */
public interface PmsUserConfigService extends IService<PmsUserConfigDto, PmsUserConfigEntity> {
    int updateConfig(Long userId, ConfigTitleEnum configTitle, String configBody);
}
