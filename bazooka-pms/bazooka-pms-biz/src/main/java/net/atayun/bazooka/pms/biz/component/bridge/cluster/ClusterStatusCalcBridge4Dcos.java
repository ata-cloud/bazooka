 ...
 */
package net.atayun.bazooka.pms.biz.component.bridge.cluster;

import net.atayun.bazooka.combase.annotation.Bridge;
import net.atayun.bazooka.combase.annotation.BridgeListAutowired;
import net.atayun.bazooka.combase.annotation.StrategyNum;
import net.atayun.bazooka.pms.biz.component.strategy.cluster.ClusterComponentStatusCalcStrategy;
